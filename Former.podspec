...
Based on the original [Former tag 1.8.1](https://github.com/ra1028/Former) library, this is a fork that has been modified to support the XCode 16.0+ and iOS 18.0+ SDKs.
end
